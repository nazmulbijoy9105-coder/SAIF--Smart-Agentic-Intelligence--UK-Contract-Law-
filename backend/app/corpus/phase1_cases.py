...
PHASE1_CASES: List[VerifiedCase] = [
    ...
    VerifiedCase("Hadley v Baxendale", "[1854] 9 Exch 341", 1854, "damages", "Remoteness — two limbs", "Damages recoverable if arise naturally or within reasonable contemplation."),
